...
export default function HamMenu() {
    ...
    <div style={{display: displayMenu ? 'flex' : 'none', top:50, left:100, position:'fixed'}}>
        <img src='/background-images/menuBackground.png' style={{position:'absolute', height: 300, width: 300, top:-45, left: -15}}/>
